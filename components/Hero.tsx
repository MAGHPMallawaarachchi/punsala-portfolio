  ...
  return (
    <section className='mx-auto max-w-7xl flex laptop:flex-row flex-col-reverse justify-center items-center h-screen overflow-x-hidden px-8'>
        ...
        {/* <div className='flex flex-row z-0 laptop:-ml-[125px] tablet:-ml-[175px] mobile:-ml-[125px] -ml-[80px]'>
            ...
            <div className='laptop:h-[500px] laptop:w-[450px] tablet:h-[530px] tablet:w-[480px] mobile:w-[290px] mobile:h-[320px] w-[215px] h-[235px] min-w-[215px] min-h-[235px] bg-pink my-[16px]'>
                <Image src='/images/portrait_1.jpg' objectFit='cover' alt='portrait_1' height={500} width={500}/>
            </div>
