...
const About = () => {
  return (
    <section className='mx-auto max-w-7xl flex laptop:flex-row flex-col-reverse justify-center items-center overflow-hidden paddings'>
        <div className='flex laptop:flex-row flex-col items-center laptop:w-full tablet:w-[80%] w-full justify-between laptop:gap-0 gap-[60px]'>
            <div className='flex flex-col laptop:justify-between laptop:w-[50%] laptop:h-[450px] laptop:gap-0 gap-8'>
            ...
            <div className='laptop:w-[450px] laptop:h-[450px] laptop:pb-0 w-full pb-[100%] bg-pink'>
