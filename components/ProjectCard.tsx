    ...
    return(
        <div className="flex lg:flex-row flex-col lg:gap-[60px] gap-5 items-center ">
            ...
            <div className="flex flex-col items-start lg:gap-10 gap-5">
                ...
                <p className="sm:text-xl text-sm dark:text-secondary-text text-dark lg:leading-9 leading-6 font-medium">{description}</p>
                <ul className="flex lg:flex-row flex-wrap gap-4 sm:text-xl text-sm dark:text-secondary-text text-dark lg:leading-9 leading-6 font-medium">
